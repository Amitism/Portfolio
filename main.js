document.addEventListener("DOMContentLoaded", function () {
    ...
    const phrases = ["Software Engineer...", "Poet...", "Human Being...", "Learner..."]
    let pharseIndex = 0;
    let letterIndex = 0;
    ...
    window.addEventListener("scroll", function () {
        ...
        if (this.window.scrollY >= (intro.offsetHeight + intro.offsetTop)) {
            this.document.getElementsByClassName(".header").style.position = "sticky";
        } else {
            this.document.getElementsByClassName(".header").style.position = "revert";
